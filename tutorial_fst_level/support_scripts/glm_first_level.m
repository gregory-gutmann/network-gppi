...
evGLM.tunits    = ['secs'];
evGLM.sub       = sub;
evGLM.folder    = {[wkdir, 'tutorial_fst_level',filesep,'data',filesep,'firstlevel',filesep,sub,filesep]};
evGLM.spmmat    = {[wkdir, 'tutorial_fst_level',filesep,'data',filesep,'firstlevel',filesep,sub,filesep,'SPM.mat']};
evGLM.design(1) = {[wkdir,'tutorial_fst_level',filesep,'data',filesep,'designmatrices',filesep,sub,'_design1.mat']};
evGLM.design(2) = {[wkdir,'tutorial_fst_level',filesep,'data',filesep,'designmatrices',filesep,sub,'_design2.mat']};
evGLM.cofounds(1)= {[wkdir,'tutorial_fst_level',filesep,'data',filesep,'cofounds',filesep,sub,'_6rigidbody_confounds1.txt']};
evGLM.cofounds(2)= {[wkdir,'tutorial_fst_level',filesep,'data',filesep,'cofounds',filesep,sub,'_6rigidbody_confounds2.txt']};
evGLM.prepro(1)= {[wkdir,'tutorial_fst_level',filesep,'data',filesep,'preprocessed',filesep,sub,'_preproc1.nii']};
evGLM.prepro(2)= {[wkdir,'tutorial_fst_level',filesep,'data',filesep,'preprocessed',filesep,sub,'_preproc2.nii']};
evGLM.preprogz(1)= {[wkdir,'tutorial_fst_level',filesep,'data',filesep,'preprocessed',filesep,sub,'_preproc1.nii.gz']};
evGLM.preprogz(2)= {[wkdir,'tutorial_fst_level',filesep,'data',filesep,'preprocessed',filesep,sub,'_preproc2.nii.gz']};
evGLM.hpf        = 180;
...
%% Save workspace
save([wkdir,'tutorial_fst_level',filesep,'parameters.mat'])
