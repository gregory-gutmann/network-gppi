...
How BrainNet Viewer can be used in shortly explaned on the main page of the 
online tutorial. To make this tutorial work, you should only need to adopt 
the working directory.

This tutorial focuses on a group contrast uisng simulated data from a
...
also contain more information on the specific evaluative process. 
...
wkdir           = 'C:\Users\grego\Desktop\gppi-network-tutorial_b\tutorial_scd_level';
