...
the Image Processing Toolbox. To shorten the runtime, I changed the number
of included ROIs to 20. If you want to run the tutorial for the whole
brain, just change or remove the marked line. Before you can run the
connectivity analysis, you also have to compute conventional activity
analysis using SPM, which are implemented in this script.
...
N.roiList           = N.roiList(1:20);  % Remove/change line if you want to 
                            % include a different set of connections
